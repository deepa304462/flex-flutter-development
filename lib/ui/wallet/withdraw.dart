    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text(
            "Current Balance is ₦$currentUserAmount",
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        ...
                        controller.text = (currentUserAmount * 0.25).toString();
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        controller.text = (currentUserAmount * 0.5).toString();
                      },
                      child: Container(
                        margin: const EdgeInsets.all(4),
                        padding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        controller.text = (currentUserAmount * 0.75).toString();
                      },
                      child: Container(
                        margin: const EdgeInsets.all(4),
                        padding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        controller.text = (currentUserAmount).toString();
                      },
                      child: Container(
                        margin: const EdgeInsets.all(4),
                        padding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
